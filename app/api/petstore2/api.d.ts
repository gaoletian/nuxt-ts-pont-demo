...
export namespace petstore2 {
  ...
  export namespace pet {
    ...
    export namespace findPetsByStatus {
      ...
      export type ResponseType = Promise<petstore2.Pet[]>;
      export function request(
        params: Params,
        options?: RequestConfig,
      ): ResponseType;
    ...
    export namespace uploadFile {
      ...
      export type ResponseType = Promise<petstore2.ApiResponse>;
      export function request(
        params: Params,
        options?: RequestConfig,
      ): ResponseType;
  ...
  export namespace store {
    ...
    export namespace placeOrder {
      export type ResponseType = Promise<petstore2.Order>;
      export function request(
        bodyParams: petstore2.Order,
        options?: RequestConfig,
      ): ResponseType;
    }
  ...
  export namespace user {
    ...
    export namespace getUserByName {
      ...
      export type ResponseType = Promise<petstore2.User>;
      export function request(
        params: Params,
        options?: RequestConfig,
      ): ResponseType;
